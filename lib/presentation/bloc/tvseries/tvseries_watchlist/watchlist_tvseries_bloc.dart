...
WatchlistTvseriesBloc
  ...
  _getWatchlistTvseries;


  final
  GetWatchListStatusTvSeries
  _getWatchListStatusTvseries;


  final
  SaveWatchlistTvSeries
  _saveWatchlistTvseries;


  final
  RemoveWatchlistTvSeries
  _removeWatchlistTvseries;
  ...
  WatchlistTvseriesBloc(
    ...
    on<
      ...
      final
      result
      = await _getWatchListStatusTvseries
          .execute(
          id
      );
    ...
    on<
      ...
      final
      result
      = await _removeWatchlistTvseries
          .execute(
          tvSeriesDetail
      );
